...
<body>
	<header class="container-fluid">
		<nav class="navbar navbar-expand-sm navbar-dark nav-transparent  nav-mine text-uppercase" style="font-family: 'Open Sans', sans-serif;">
			...
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item px-3"><a class="nav-link" href="gallery.html"><img src="image/si-glyph-folder.svg" width="20px" height="20px" alt="sample"> Gallery</a></li>
				<li class="active nav-item px-3"><a class="nav-link" href="contact.php"><img src="image/si-glyph-contact-book.svg" width="20px" height="20px" alt="contact"> Contact</a></li>
			</ul>
		</nav>
	</header>
				...
				<div class="col-sm-8">
					...
					<form action="input.php" method="post">
						...
						<div class="form-group">
							...
							<input type="email" name="email" class="form-control" placeholder="abc@123.com" required>
						</div>
						<div class="form-group">
							<label for="comment" class="col-form-label">Comment</label>
							<textarea type="text" class="form-control" rows="8"></textarea>
						</div>
						<button onclick="myfunc1()" type="submit" class="btn btn-primary btn-lg" >Submit</button>
						<div id="writehere" class="pt-4 text-success">
							<?php
									echo "Thank you ". $_POST["name"]. ", we will contact you at our earlist convenient";
							?>
						</div>
					</form>
				</div>
	...
	<footer class="d-block bg-dark mt-4 fixed-bottom webfont">
