        	...
        	<div class="row mx-auto">
        		<div class="col-md-4">
		        	<ul class="list-group nav">
		        		...
		        		<li class="active list-group-item"><a href="piechart.php" class="nav-link text-white">[Data Visualization] Players in world top 25% pie chart</a> </li>
		        		...
		        		<li class="list-group-item"><a href="todo/todopage.php" class="nav-link text-dark">[Server-Side Persisitent Storeage] To Do List</a></li>
		        		<li class="list-group-item"><a href="auth.php" class="nav-link text-dark">[Authentication] Quarantine Area</a></li>

		        	</ul>
		        </div>

		        <div class="col-md-8" id="chart_div" style="padding-left: 5%;">
		        	<?php require 'imports/piechart_scripts.php'; ?>
		        </div>
        	</div>
        </div>
	</main>
